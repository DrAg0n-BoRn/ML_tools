...
class MLTaskKeys:
    ...
    AUTOREGRESSIVE_SEQUENCE_SEQUENCE = "autoregressive-sequence-to-sequence"
    AUTOREGRESSIVE_SEQUENCE_VALUE = "autoregressive-sequence-to-value"
    EXOGENOUS_SEQUENCE_SEQUENCE = "exogenous-sequence-to-sequence"
    EXOGENOUS_SEQUENCE_VALUE = "exogenous-sequence-to-value"
    
    DIFFUSION = "diffusion"
    AUTOENCODER = "autoencoder"
    
    ALL_BINARY_TASKS = [BINARY_CLASSIFICATION, 
                        MULTILABEL_BINARY_CLASSIFICATION, 
                        BINARY_IMAGE_CLASSIFICATION, 
                        BINARY_SEGMENTATION]
    
    ALL_SEQUENCE_TASKS = [AUTOREGRESSIVE_SEQUENCE_SEQUENCE, 
                          AUTOREGRESSIVE_SEQUENCE_VALUE, 
                          EXOGENOUS_SEQUENCE_SEQUENCE, 
                          EXOGENOUS_SEQUENCE_VALUE]
    ...
    ALL_TASKS = [REGRESSION, MULTITARGET_REGRESSION, 
                 ...
                 OBJECT_DETECTION, 
                 AUTOREGRESSIVE_SEQUENCE_SEQUENCE, AUTOREGRESSIVE_SEQUENCE_VALUE, 
                 EXOGENOUS_SEQUENCE_SEQUENCE, EXOGENOUS_SEQUENCE_VALUE,
